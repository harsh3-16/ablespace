...
describe('ProductsService', () => {
    ...
    let detailRepo: jest.Mocked<Repository<ProductDetail>>;
    ...
    const mockProductDetail: Partial<ProductDetail> = {
        id: 'detail-id-1',
    ...
    beforeEach(async () => {
        ...
        const module: TestingModule = await Test.createTestingModule({
            providers: [
                ...
                { provide: getRepositoryToken(ProductDetail), useValue: mockDetailRepository },
        ...
        detailRepo = module.get(getRepositoryToken(ProductDetail));
    ...
    describe('upsertProduct', () => {
        it('should update existing product', async () => {
            ...
            productRepo.findOne.mockResolvedValueOnce({ ...mockProduct, title: 'Updated' } as Product);
